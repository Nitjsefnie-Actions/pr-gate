...
class _RenderedBodyParser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if (self._heading_tag is None and self._key is not None
            ...
            self._content.append(ContentToken('start', tag))
        if tag == 'img':
    ...
    def handle_endtag(self, tag):
        ...
        if (self._heading_tag is None and self._key is not None
                and self._region_depth is None and depth > self._section_depth):
            self._content.append(ContentToken('end', tag))
        self._open_tags.pop()
        ...
        self._issues = []
        self._content = []
        self._section_depth = len(self._open_tags)
        self._heading_tag = None
        self._heading_parts = []
        self._break_closing_list()
    ...
    def _record_text(self, data):
        ...
        if self._heading_tag is not None:
            ...
            self._content.append(ContentToken('text', data))
    ...
    def _finish_section(self):
        ...
        self.sections.append(Section(
            ...
            tuple(self._links), tuple(self._issues), tuple(self._content)))
        self._name = None
        self._key = None
        self._text = []
        self._links = []
